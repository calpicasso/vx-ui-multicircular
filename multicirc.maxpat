...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.0, 50.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 381.0, 112.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 381.0, 78.0, 180.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.5, 119.0, 593.0, 35.0 ],
									"text" : "clear, add 16 8 1, add 8 4 1, setdrawmode 1, setoffthicknessmul 0.24, spacing 2.61, thickness 1.45, innerarea 0.79, setactivecolor 0 0.34375 1. 0.25 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 147.0, 250.0, 451.0, 35.0 ],
									"text" : "clear, add, add, add 5 2 1, spacing 0.8, thickness 1, innerarea 0.9, setdrawmode 0, setoffthicknessmul 1"
								}
...
,
					"patching_rect" : [ 381.0, 141.0, 49.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 441.0, 80.0, 22.0 ],
					"text" : "setindex $1 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 34.0, 574.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 632.5, 124.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 626.5, 720.0, 58.0, 22.0 ],
					"text" : "s ui_prop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 756.5, 58.0, 22.0 ],
					"text" : "s ui_prop"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 228.25, 283.5, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 228.25, 344.0, 75.0, 22.0 ],
					"text" : "counter 1 32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 228.25, 313.0, 66.0, 22.0 ],
					"text" : "metro 16n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.5, 692.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 626.5, 661.0, 97.0, 22.0 ],
					"text" : "funnel 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 704.5, 622.0, 20.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_shortname" : "1",
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 678.5, 622.0, 20.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_shortname" : "1",
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 652.5, 622.0, 20.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_shortname" : "1",
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 626.5, 622.0, 20.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_shortname" : "1",
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"text" : "setactivecolor 0 0.34375 1. 0.25 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 263.0, 27.0, 22.0 ],
					"text" : "s ui"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.25, 531.0, 58.0, 22.0 ],
					"text" : "s ui_prop"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 228.25, 379.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.25, 413.0, 80.0, 22.0 ],
					"text" : "setindex $1 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 34.0, 400.864622944792586, 124.0, 132.135377055207414 ],
					"varname" : "jsui[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 295.0, 50.0, 22.0 ],
					"text" : "compile"
				}
